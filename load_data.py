...
def additional_data(args):
    ...
    add_data = load_data('../dataset/train/train.csv', args).rename(columns=config["change_entity"])
...
def train_data_with_addition(args):
    added_data = load_data('../dataset/train/train.csv', args).append(additional_data(args))
