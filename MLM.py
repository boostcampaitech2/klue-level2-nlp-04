...
class Config:
    ...
    nlp_model_name: str = "klue/roberta-large"

    epochs: int = 2
    save_step: int = 30000

    dataset_dir: str = '/opt/ml/dataset/train' # ex) /opt/ml/dataset/train/train.csv 이라면 '/opt/ml/dataset/train' 부분을 넣어주면 됩니다(상대 경로도 가능합니다).
    batch_size: int = 32
